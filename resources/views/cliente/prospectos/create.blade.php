    ...
    <form method="POST" action="{{ route('prospectos.store') }}">
        ...
        <div class="card-body">
            ...
            <div class="col-4 form-group" id="contenedorInputDespachoImportacion" style="display: none">
                <label><i class="fas fa-asterisk"></i> Despacho de importación</label>
                <input type="checkbox" class="form-control" name="despacho_importacion" class="tipoDespacho" id="inputDespachoImportacion">
            </div>
            <div class="col-4 form-group" id="contenedorInputDespachoExportacion" style="display: none">
                ...
                <input type="checkbox" class="form-control" name="despacho_exportacion" class="tipoDespacho" id="inputDespachoExportacion">
            </div>
