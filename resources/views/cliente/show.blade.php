	...
	<div class="card-body">
		<div>
			<ul class="nav nav-tabs" id="clientesTabs" role="tablist">
				...
				<li class="nav-item"><a href="#proyectos" class="nav-link" id="proyectoTab" data-toggle="tab" role="tab" aria-controls="proyectos" aria-selected="true">Solicitud de cotizaciones</a></li>
